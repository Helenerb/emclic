...
data = {'grant_type' : 'password', 'client_id' : '6221fa3fa7afb20de310c20c', 'client_secret' :'yXf8j8sJMdVZ0TiU7yQH7N6iRuoQyoNgP', 'username' : "hebe@cicero.oslo.no", 'password' : 'rNJw_p8H6W4KbF'}
print("\n data: \n", data, "\n")
